...
import { sopernw, transaction, user } from "../../class/models/models";
...
export class ProfilePage {
  ...
  loadingProfile = true;
  user: user;
  constructor(private _sopernw: SopernwProvider, private _sessions: sessions,public navCtrl: NavController, public navParams: NavParams, public modalCtrl: ModalController) {
